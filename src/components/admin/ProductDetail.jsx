                ...
                <table className="w-full text-left border border-collapse sm:border-separate border-pink-100 text-pink-400">
                    ...
                    <tbody>
                        {getAllProduct.map((item, index) => {
                            ...
                            return (
                                <tr key={id} className="text-pink-300"> {/* Changed key to id */}
                                    <td className="h-12 px-6 text-md border-t border-pink-100 stroke-slate-500 text-slate-500">
                                        {index + 1}.
                                    </td>
                                    <td className="h-12 px-6 text-md border-t border-pink-100 stroke-slate-500 text-slate-500">
                                    ...
                                    <td 
                                        ...
                                        className="h-12 px-6 text-md border-t border-pink-100 stroke-slate-500 text-green-500 cursor-pointer"
                                    >
                                        Edit
                                    </td>
                                    <td 
                                        onClick={() => deleteProduct(id)}
                                        className="h-12 px-6 text-md border-t border-pink-100 stroke-slate-500 text-red-500 cursor-pointer"
                                    >
                                        Delete
                                    </td>
                                </tr>
