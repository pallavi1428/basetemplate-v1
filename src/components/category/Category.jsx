        ...
        <div>
            <div className="flex flex-col mt-5">
                <div className="flex overflow-x-scroll lg:justify-center hide-scroll-bar">
                    <div className="flex">
                        {category.map((item) => { // Removed unused index
                            return (
                                <div key={item.name} className="px-3 lg:px-10"> {/* Using item.name as key */}
                                    <div 
                                    ...
                                    >
                                        <div className="flex justify-center mb-12">
                                            <img src={item.image} alt={item.name} /> {/* Added descriptive alt */}
                                        </div>
                                    </div>
